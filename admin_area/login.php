...
<html lang="en">
	...
	<body>
		<div class="container"> <!-- container mulai -->
			<form action="" class="form-login" method="post"> <!-- form-login mulai -->
				...
				<button type="submit" class="btn btn-lg btn-primary btn-block" name="admin_login"> <!-- btn btn-lg btn-primary btn-block mulai -->
					Login
				</button> <!-- btn btn-lg btn-primary btn-block selesai -->
			</form> <!-- form-login selesai -->
